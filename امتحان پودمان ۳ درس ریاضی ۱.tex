...
کدام تصویر مربوط به حل معادله به روش هندسی معادل $4x^2 + x + 7 = -1$ است؟
    \begin{fourchoice}[2]\choice{\includegraphics[scale = 0.35]{y__=___+_0.25x__+__2_and_y__=__x_power_2}}
\choice{\includegraphics[scale = 0.35]{y__=___+_0.25x__+___-_2_and_y__=__x_power_2}}
\choice{\includegraphics[scale = 0.35]{y__=___-_0.5x_+_3_and_y__=__x_power_2}}
\choice{\includegraphics[scale = 0.35]{y__=___-_2x_and_y__=__x_power_2}}
\end{fourchoice}
