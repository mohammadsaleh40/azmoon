...
first_text = add_multiparts(first_text , "نقیض هر یک از گزاره‌های زیر را بنویسید.", list_part=["عدد $2$ فرد است." ,"مجموع زوایای داخلی یک مثلث $180$ درجه است."], barom = 1)
...
first_text = add_multiparts(first_text , "صحت گزاره‌های زیر را بررسی کنید در صورت اشتباه بودن مثال نقض ارائه کنید.", list_part=["در تمام مثلث‌ها نقطه تقاطع عمود منصف‌ها داخل مثلث است.","در هیچ مثلثی ارتفاع‌های مثلث بر اضلاع آن منطبق نمی‌شود.", "میانه ساق‌های مثلث متساوی الساقین‌همیشه هم دیگر را بیرون مثلث قطع می‌کنند.","عمود منصف‌های هر دو وتر از یک دایره فقط در مرکز دایره هم دیگر را قطع می‌کنند."], barom=2 )
first_text = add_question(first_text , "قضیه زیر را به کمک برهان خلف اثبات کنید:\\\\قضیه: از هر نقطه غیر واقع بر یک خط نمی‌توان بیش از یک خط بر آن خط عمود رسم کرد.", barom=2)
