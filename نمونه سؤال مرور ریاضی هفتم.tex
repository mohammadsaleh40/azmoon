...
دو چرخنده با پس زمینه‌های زیر داریم. در کدام یک احتمال ایستادن چرخنده بر روی رنگ قرمز بیشتر است؟ چرا؟ \\  \includegraphics[scale = 0.5]{ehtemalat_barabar_haftom}}\question{%
خانواده آقای جانسون می‌خواهند برای مسافرت در تعطیلات سال نو خود بین مسافرت زمینی 
...
که به کمک اتوبوس انجام شده حدود 20 میلیون نفر کشته شده‌اند و در بین 100 میلیارد سفری که به کمک هواپیما انجام شده حدود 16 هزار نفر کشته شده‌اند. اگر این خانواده بخواهند گزینه امن تر را  انتخاب کنند پیشنهاد شما مسافرت با اتوبوس است یا هواپیما؟ چرا؟‌
\\‌
\\‌
\\‌
\\}\end{questions}
