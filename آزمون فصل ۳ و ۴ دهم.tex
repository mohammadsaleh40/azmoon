...
\\}\question{%
    ...
    \begin{LTR}
        \begin{parts}\part{$\sqrt[4]{16}\times\sqrt[4]{81} = $}
...
\\}\question{%
    ...
    معادله زیر را به روش دلتا\underline{} حل کنید. \begin {LTR}$x^2+6x = 2$ \\ \\ \\ \\ \end{LTR}}\question{%
    جدول تعیین علامت عبارت زیر را بنویسید. \begin {LTR} $x^2+6x-2$ \\ \\ \\ \\ \end{LTR}}\question{%
    نا معادله‌های زیر را حل کنید.
    \begin{LTR}
        \begin{parts}\part{$|\dfrac{x-1}{2}-1| \geq 0$}
