...
first_text = add_multiparts(first_text , "برد هر یک از توابع زیر را با توجه به ضابطه و دامنه داده شده بدست آورید." , list_part=["$\\includegraphics[scale = 0.35]{Screenshot_2024-02-04-20-41-59-786_cn.wps.moffice_eng}$" , "$\\includegraphics[scale = 0.35]{Screenshot_2024-02-04-20-42-57-989_cn.wps.moffice_eng}$"], khat=2 , barom=1)
