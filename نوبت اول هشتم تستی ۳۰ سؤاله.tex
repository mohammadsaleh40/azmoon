...
\\
	...
	\end{fourchoice}
		...
		\question{
			یک سالن ورزشی داریم که به تازگی به بخش انتهایی آن یک تشک بزرگ یکپارچه اضافه شده. ۱۶ متر انتهایی این سالن حتما باید تشک می‌شد. ولی صاحب باشگاه مقدار بیشتری از این باشگاه را تشک کرده. اگر هر متر تشک ۱۰۰،۰۰۰ تومان باشد و هزینه تشک سالن ۲۴،۰۰۰،۰۰۰ تومان شده باشد. چند متر اضافه تر از طول سالن تشک شده است؟
			\\
